...
function underscores_scripts() {
	...
	wp_enqueue_style( 'underscores-main', get_template_directory_uri() . '/css/main.css', array(), '1.0', 'all');

	wp_enqueue_script( 'underscores-navigation', get_template_directory_uri() . '/js/navigation.js', array(), _S_VERSION, true );
	wp_enqueue_script( 'underscores-jquery', get_template_directory_uri() . '/js/jquery.js', array('jquery'));

	wp_enqueue_script( 'feather-icons', 'https://unpkg.com/feather-icons', false );
...
function add_google_fonts() {
	wp_enqueue_style( 'open-sans', 'https://fonts.googleapis.com/css2?family=Open+Sans:ital,wght@0,400;0,700;1,400;1,700&display=swap', false );
	wp_enqueue_style( 'permanent-marker', 'https://fonts.googleapis.com/css2?family=Permanent+Marker&display=swap', false );
	wp_enqueue_style( 'indie-flower', 'https://fonts.googleapis.com/css2?family=Indie+Flower&display=swap', false );
	wp_enqueue_style( 'caveat', 'https://fonts.googleapis.com/css2?family=Caveat:wght@500&display=swap', false );
}	 
